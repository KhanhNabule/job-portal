...
class EditJob extends React.Component {
  ...
  handleSubmit(event) {
    ...
    editJobInfo(this.props.match.params.id, jobRequest)
      .then((response) => {})
      .catch(Alert.success("Cập nhật thông tin thành công!!"));
  }
                  ...
                  <form onSubmit={this.handleSubmit}>
                    <div class="row">
                      <div class="mb-3 col-md-6">
                        <label class="form-label" for="inputEmail5">
                          Tên Công ty
                        </label>
                        <input
                          type="text"
