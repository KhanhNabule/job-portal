...
-- CREATE TABLE tbl_recruiment (
-- 	`id` bigint(20) not null auto_increment,
--     `job_id` bigint(20) default null,
--     `jobseeker_id` bigint(20) default null,
--     `is_answer` bit(1) default null,
--     primary key(`id`),
--     
-- 	KEY `FK_JOB_idx` (`job_id`),
-- 	CONSTRAINT `FK_JOB` FOREIGN KEY (`job_id`) 
-- 	REFERENCES `tbl_job` (`id`),
--     
--     KEY `FK_JOBSEEKER_idr` (`jobseeker_id`),
-- 	CONSTRAINT `FK_JOBSEEKER_rec` FOREIGN KEY (`jobseeker_id`) 
...
VALUES ('master@gmail.com', 0, 'master','autoupad', 'local', 0);

-- INSERT INTO users (created_at, updated_at, email, email_verified, image_url, name, password, provider, provider_id, is_locked) 
-- VALUES ('2024-05-02 15:00:00', '2024-01-23 18:00:00', 'tranthanhhang@gmail.com', 1, 'null', 'Duy Khanh','autoupad1', 'Hang', 2, 0);

-- INSERT INTO users (created_at, updated_at, email, email_verified, image_url, name, password, provider, provider_id, is_locked) 
-- VALUES ('2024-05-01 15:00:00', '2024-01-22 18:00:00', 'khanhvuviruss7@gmail.com', 1, 'null', 'Khanh','autoupad12', 'Khanh12',3 , 0);
